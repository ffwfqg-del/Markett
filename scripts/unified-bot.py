...
добавь бэкенд фулл но убери все что свзяано со звездами, самое главное передача подакров и админ меню и остальное тоже. ПЕРЕНИСИ ПОЧТИ ВСЮ МОДЕЛЬ КОДА


прежним оставь ток связь кода с сайтом
